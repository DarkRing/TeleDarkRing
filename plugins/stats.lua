...
local function run(msg, matches)
  if matches[1]:lower() == 'teledarkring' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /teledarkring ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "teledarkring" then -- Put everything you like :)
